/**
 * Register Trainer Screen - Individual trainer registration
 */
...
export default function RegisterTrainerScreen() {
  ...
  const texts = {
    tr: {
      title: 'Eğitmen Kaydı',
      warningTitle: 'Dikkat!',
      warningMessage: 'Bu sayfa bireysel eğitmen kaydı içindir. Eğer stüdyo sahibi veya üye olarak kayıt olmak istiyorsanız, lütfen geri dönüp uygun seçeneği seçin.',
    ...
    en: {
      ...
      warningMessage: 'This page is for individual trainer registration. If you want to register as a studio owner or member, please go back and select the appropriate option.',
